    ...
    <body>
				...
				<?php foreach ($Products as $Product) : ?>
                    <div class="col mb-5">
                        <div class="card h-100">
							...
							<input class="delete-checkbox" type="checkbox" id="<?php echo $Product['SKU'] ?>" name="delete[]" value="<?php echo $Product['SKU'] ?>"></div>
                            <!-- Product image-->
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder"><?php echo $Product['SKU'] ?></h5>
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#"><?php  if (isset($Product['Attribute'])) echo $Product['Attribute']; ?></a></div>
                            </div>
                        </div>
                    </div>
					<?php endforeach; ?>
      ...
      (function() {
		...
		mass_delete.addEventListener('click', async function(e) {
			e.preventDefault();
          const matches = document.querySelectorAll(".delete-checkbox");
          matches.forEach((checkbox) => {
			  if(checkbox.checked){
				  FD.append(checkbox.name,checkbox.value );
			  }
            
          });
		  var deleteDone = false;
		  if (Array.from(FD.keys()).length > 0){
		  deleteDone = await new Promise(resolve => {
