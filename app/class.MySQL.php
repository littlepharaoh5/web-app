...
class MySQL extends Safe{
    ...
    public function __construct(){
        parent::__construct();
        try{
            $this->host         = "fdb1029.awardspace.net";
            $this->user         = "4503257_shop";
            $this->password     = "jvGU-#Dq5!o/Z%J#";
            $this->database     = "4503257_shop";
	...
	public function Delete($table, $condition = "", $clause = " OR "){
